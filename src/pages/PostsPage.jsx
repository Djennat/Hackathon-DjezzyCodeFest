...
import { FaRegPaperPlane, FaFacebook, FaInstagram, FaPhone, FaLightbulb, FaSearch } from 'react-icons/fa';
            ...
            {filteredPosts.map((post) => (
              <div key={post.id} className="post-card">
                ...
                <div className="post-info">
                  <h2 className="h">
                    {post.title}
                    <FaRegPaperPlane className="icon-share" onClick={() => handleShare(post.id)} />
                  </h2>
